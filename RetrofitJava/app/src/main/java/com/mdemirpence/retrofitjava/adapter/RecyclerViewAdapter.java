package com.mdemirpence.retrofitjava.adapter;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.RowHolder> {
    ...
    private ArrayList<KriptoModel> cryptoList;

    private String[] colors = {"#ffea6b","#c9ede7","#fee6f7","#c0ffee","#c0ffee","#a3ff00","#a3ff00","#fee6f7"};

    public RecyclerViewAdapter(ArrayList<KriptoModel> cryptoList) {
